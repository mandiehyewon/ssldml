...
class Criterion(torch.nn.Module):
    def __init__(self, args, batchminer):
        ...
        self.tan_angular_margin = np.tan(np.pi/180*args.loss_angular_alpha)
        self.lam            = args.loss_angular_npair_ang_weight
        self.l2_weight      = args.loss_angular_npair_l2
    ...
    def forward(self, batch, labels, **kwargs):
        ...
        is_term1 = 4*self.tan_angular_margin**2*(n_anchors + n_positives)[:,None,:].bmm(n_negatives[:,None,:].permute(0,2,1))
